...
class UserForm extends React.Component {
	...
	componentDidMount() {
		if(this.props.editMode) {
			this.props.form.setFieldsValue(this.props.userInfo);
		}
	}
	...
	handleSubmit = (e) => {
		...
		setTimeout(() => {
			this.props.form.validateFields((err, values) => {
                ...
                this.props.closeDrawer('visibleUserForm'); // close user form drawer on success
	...
	render() {
		...
		return (
			<Drawer
				...
				placement="left"
				width={720}
				onClose={(e) => this.props.closeDrawer('visibleUserForm')}
			...
			>
				...
				>
					<Button onClick={(e) => this.props.closeDrawer('visibleUserForm')} style={{ marginRight: 8 }}>
						Cancel
					</Button>
